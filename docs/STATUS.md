...
- 🟡 **Live-verify built screens** — Market buy/sell/cancel, Syndicate CRUD, Leaderboard, Settings gamepasses, FormulaLog/ExoticRegistry, Contract/Streak claim, Event/Flux UI, **Cosmetics Lab-tab** (built; needs playtest).
